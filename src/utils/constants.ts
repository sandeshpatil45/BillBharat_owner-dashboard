...
export const API_ENDPOINTS = {
  ...
  REPORTS: {
    ...
    HOME_DASHBOARD: '/api/reports/home-dashboard',
    SALES_TREND: '/api/reports/sales-trend',
    DASHBOARD_ALERTS: '/api/reports/dashboard-alerts',
    FINANCE: '/api/reports/finance',
    SALES_TEAM: '/api/reports/sales-team',
    EXECUTIVE_DETAIL: (execId: string) => `/api/reports/executive/${execId}`,
  },
  MERCHANTS: {
    LIST: '/api/merchants',
    DETAIL: (id: string) => `/api/merchants/${id}`,
    STATS: '/api/merchants/stats',
  },
  PRINTERS: {
    DATA: '/api/printers/overview',
    LOCATIONS: '/api/printers/locations',
    INVENTORY: '/api/printers/inventory',
    MAC_REGISTRY: '/api/printers/mac-registry',
  },
  PAPER_ROLLS: {
    DATA: '/api/paper-rolls/overview',
    INVENTORY: '/api/paper-rolls/inventory',
    REVENUE: '/api/paper-rolls/revenue',
    REORDER_PREDICTIONS: '/api/paper-rolls/reorder-predictions',
  },
  BELTS: {
    DATA: '/api/belts/overview',
    PERFORMANCE: '/api/belts/performance',
    MAP_MARKERS: '/api/belts/map-markers',
    SATURATION: '/api/belts/saturation',
  },
  RENEWALS: {
  ...
  DOWNLOADS: {
    REPORT: (reportId: string) => `/api/downloads/report/${reportId}`,
    LIST: '/api/downloads/reports-list',
  },
  SETTINGS: {
